...
static ssize_t razer_attr_read_get_firmware_version(struct device *dev, struct device_attribute *attr, char *buf)
{
    ...
    case USB_DEVICE_ID_RAZER_DEATHADDER_3500_OLD: // DA don't think supports fw, its proper old
        return sprintf(buf, "v%d.%d\n", 0x01, 0x00);
        break;
...
static ssize_t razer_attr_write_device_mode(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
{
    ...
    if(count == 2) {
        ...
        case USB_DEVICE_ID_RAZER_DEATHADDER_3500_OLD: // Doesn't support device mode, exit early
            return count;
            break;
        case USB_DEVICE_ID_RAZER_NAGA_HEX_V2:
        case USB_DEVICE_ID_RAZER_DEATHADDER_ELITE:
...
static const struct hid_device_id razer_devices[] = {
    ...
    { HID_USB_DEVICE(USB_VENDOR_ID_RAZER,USB_DEVICE_ID_RAZER_DEATHADDER_3500_OLD) },
